...
export default function ProductionSection() {
  ...
  const productionCapacity = [
    ...
    },
    {
      ...
      capacity: isId ? "234 kontainer/bulan" : "234 containers/month",
    ...
    },
    {
      ...
      capacity: isId ? "20–40 kontainer/bulan" : "20–40 containers/month",
  ...
  return (
    <section className="py-12 md:py-20 bg-soft-beige">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12 md:mb-20">
          <div>
            ...
            <div className="mt-6 bg-white rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg overflow-x-auto -mx-4 sm:mx-0">
          ...
          <div>
            ...
            <p className="text-gray-700">{t("production.sop")}</p>
          </div>
        </div>
      </div>
    </section>
